    ...
    <div class="row">
      <div class="col-md-12">
        <div class="panel panel-default panel-border-color panel-border-color-primary">
          <div class="panel-heading panel-heading-divider" >Trabajadores por Rubro<span class="panel-subtitle">Actualizar monto de los rubros</span></div>
          <div class="panel-body">
            <form method="POST" action="{{ url('/agregar-usuario/'.$idopcion) }}" style="border-radius: 0px;" class="form-horizontal group-border-dashed">
              ...
              <div class="form-group">
                  <label class="col-sm-3 control-label">Trabajadores</label>
                  <div class="col-sm-5 input-group xs-mb-15">

                    <input type="text" 
                          class="selecttrabajador input-sm" 
                          data-url="{{url('/lista-de-trabajadores-json.json')}}"
                          data-load-once="true" 
                          name="language" />
              ...
              <div class="listajax panel-body listadotrabajadores"></div>
